...
12. Install .NET Frameworks on the 3 servers. Open PowerShell and run the following command.
...
13. Now we are going to install ADDS (Active Directory Domain Services) on hjc-adprod server. Before that, reconfigure the DNS address of the server first. Set the preferred DNS same as with the server IPv4 Address as shown below:

![image](https://user-images.githubusercontent.com/95063830/171328607-3cfec5da-e1d2-4057-ad41-50732fc1447d.png)

14. Open PowerShell or CMD and run the following:
...
15. Install ADDS and DNS Server Role using powerShell
...
16. Install ADDS Forest by using PowerShell. Run the following on PowerShell.
...
17. AD Forest (HJCDOM) successfully installed!
